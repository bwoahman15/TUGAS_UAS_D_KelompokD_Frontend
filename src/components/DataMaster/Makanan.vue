<template>
  <v-main class="list">
    <h3 class="text-h3 font-weight-medium mb-5"> Makanan </h3>
    <v-card>
      <v-card-title>
    ...
    <v-dialog v-model="dialog" persistent max-width="600px">
      <v-card>
        ...
        <v-card-text>
          <v-container>
            <v-text-field v-model="form.makanan" label="makanan" required></v-text-field>
            <v-text-field v-model="form.jumlah" label="Jumlah" required></v-text-field>
          </v-container>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
    ...
    <v-dialog v-model="dialogConfirm" persistent max-width="400px">
      <v-card>
        ...
        <v-card-text> Anda Yakin ingin menghapus makanan ini? </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
...
export default {
    ...
    methods: {
        ...
        save() {
            this.makanan.append('makanan', this.form.makanan);
            this.makanan.append('jumlah', this.form.jumlah);
